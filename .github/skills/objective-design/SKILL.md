...
- Use explicit method calls between world and objective runtime; avoid string-dispatch helper wrappers (for example `_call(method: String, ...)` + `callv`) for internal objective plumbing.
