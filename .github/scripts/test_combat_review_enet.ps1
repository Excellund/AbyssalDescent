...
$testRoot = Join-Path $tempRoot ('abyssal-combat-review-enet-' + [guid]::NewGuid().ToString('N'))
...
try {
    ...
    $common = @('--script', 'res://validation_entry.gd', '--quit-after', '2000', '--', 'res://scripts/tests/test_combat_review_enet.gd')
