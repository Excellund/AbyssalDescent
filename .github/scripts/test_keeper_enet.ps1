...
$testRoot = Join-Path $tempRoot ('abyssal-keeper-enet-' + [guid]::NewGuid().ToString('N'))
...
try {
    ...
    $common = @('--script', 'res://validation_entry.gd', '--quit-after', '2000', '--', 'res://scripts/tests/test_keeper_enet.gd')
