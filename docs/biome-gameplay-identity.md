...
Biome terrain applies to Skirmish, Pursuit, Crossfire, Onslaught, Fortress, Blitz, Suppression, Vanguard, Ambush, Convergence and Gauntlet. Most terrain families have two orientations. Breach, Undertow, Missions, Trials, Apex rooms, tutorials and bosses retain their authored arenas. Unknown biome IDs retain the existing layout pools. Obstacles remain permanent circles with the existing column/boulder radii.
