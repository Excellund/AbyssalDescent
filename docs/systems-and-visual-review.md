...
Full verification and delivery evidence are recorded in the overnight log. The normal `dev-overnight-rooms-20260909-020731` desktop checkpoint includes the new content and the Archer, ownership and actual Breakwater room-entry corrections. Toll/Pyre are verified and await their next export.
