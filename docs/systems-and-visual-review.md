...
Full verification and delivery evidence are recorded in the overnight log. The normal `dev-overnight-pulses-20260909-023251` desktop checkpoint includes the new content and the Archer, ownership, actual Breakwater room-entry and Toll/Pyre corrections.
