...
@export_enum("None", "Rest Site", "Skirmish", "Crossfire", "Fortress", "Onslaught", "Vanguard", "Blitz", "Ambush", "Suppression", "Gauntlet", "Convergence", "Objective - Last Stand", "Objective - Cut the Signal", "Objective - Hold the Line", "Objective - Circuit Sweep", "Objective - Pulse Window", "Objective - Intercept Run", "Objective - Random", "Trial", "Apex Seamlock", "Apex Mirrorline", "Apex Toll", "Warden", "Sovereign", "Lacuna", "Undertow", "Breach") var start_encounter: int = DEBUG_ENUMS.Encounter.NONE
