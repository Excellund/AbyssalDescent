...
# Lurker (deep crimson, predatory)
const COLOR_LURKER_BODY := Color(0.56, 0.08, 0.18, 1.0)
const COLOR_LURKER_CORE := Color(1.0, 0.48, 0.28, 1.0)
const COLOR_LURKER_BODY_LURK := Color(0.86, 0.12, 0.22, 1.0)
const COLOR_LURKER_CORE_LURK := Color(1.0, 0.78, 0.3, 1.0)
const COLOR_LURKER_BODY_STRIKE := Color(1.0, 0.22, 0.3, 1.0)
const COLOR_LURKER_CORE_STRIKE := Color(1.0, 0.9, 0.5, 1.0)
const COLOR_LURKER_EYE_GLOW := Color(1.0, 0.32, 0.2, 1.0)
const COLOR_LURKER_LUNGE_RING := Color(1.0, 0.68, 0.28, 1.0)
const COLOR_LURKER_FANG := Color(1.0, 0.64, 0.32, 1.0)

# Ram (aggressive amber, multi-charger)
const COLOR_RAM_BODY := Color(0.72, 0.32, 0.06, 1.0)
const COLOR_RAM_CORE := Color(1.0, 0.68, 0.2, 1.0)
const COLOR_RAM_BODY_WINDUP := Color(0.86, 0.4, 0.06, 1.0)
const COLOR_RAM_CORE_WINDUP := Color(1.0, 0.82, 0.36, 1.0)
const COLOR_RAM_BODY_CHARGE := Color(1.0, 0.52, 0.1, 1.0)
const COLOR_RAM_CORE_CHARGE := Color(1.0, 0.92, 0.5, 1.0)
const COLOR_RAM_PIP_READY := Color(1.0, 0.86, 0.42, 1.0)
const COLOR_RAM_PIP_LIT := Color(1.0, 0.92, 0.56, 1.0)
const COLOR_RAM_HORN := Color(1.0, 0.76, 0.36, 1.0)
