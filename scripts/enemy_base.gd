...
const COLOR_DRIFTER_BODY := COLOR_PALETTE.COLOR_DRIFTER_BODY
const COLOR_DRIFTER_CORE := COLOR_PALETTE.COLOR_DRIFTER_CORE
const COLOR_DRIFTER_RING := COLOR_PALETTE.COLOR_DRIFTER_RING
const COLOR_WEAVER_BODY := COLOR_PALETTE.COLOR_WEAVER_BODY
const COLOR_WEAVER_CORE := COLOR_PALETTE.COLOR_WEAVER_CORE
const COLOR_WEAVER_PROJECTILE := COLOR_PALETTE.COLOR_WEAVER_PROJECTILE
const COLOR_SENTINEL_BODY := COLOR_PALETTE.COLOR_SENTINEL_BODY
const COLOR_SENTINEL_CORE := COLOR_PALETTE.COLOR_SENTINEL_CORE
const COLOR_SENTINEL_CONE_FILL := COLOR_PALETTE.COLOR_SENTINEL_CONE_FILL
const COLOR_SENTINEL_CONE_OUTLINE := COLOR_PALETTE.COLOR_SENTINEL_CONE_OUTLINE
const CROWD_SEPARATION_RECOMPUTE_INTERVAL_SEC_DEFAULT: float = 0.08
const REMOTE_UI_UPDATE_INTERVAL_SEC_DEFAULT: float = 0.08
...
@export var crowd_separation_recompute_interval_sec: float = CROWD_SEPARATION_RECOMPUTE_INTERVAL_SEC_DEFAULT
...
@export var remote_ui_update_interval_sec: float = REMOTE_UI_UPDATE_INTERVAL_SEC_DEFAULT
